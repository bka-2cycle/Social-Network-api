...
module.exports = {
  ...
  // Remove thought reaction. This method finds the reaction based on ID. It then updates the reaction array associated with the thought in question by removing it's reactionId from the reactions array.
